...
homing = true
# Set to false if you don't plan to use tiling features for current session
tiling = false
# Set autofocus average offset from homed z stage for fast autofocus, set 0 to disable autofocus
autofocus = 0
