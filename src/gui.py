...
class StagePositionFrame:
    def __init__(self, parent, event_dispatcher: EventDispatcher):
        ...
        self.chip_origin_button = ttk.Button(self.shortcut_frame, text="Chip origin", command=on_chip_origin)
        self.chip_origin_button.grid(row=0, column=0)
        self.chip_unload_button = ttk.Button(self.shortcut_frame, text="Load/unload", command=on_chip_unload)
